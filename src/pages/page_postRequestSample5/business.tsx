...
import { postService1TkV1RequestTestPostRequestMultipartFormData2Async, PostService1TkV1RequestTestPostRequestMultipartFormData2AsyncRequestBody } from '../../repositories/network/apis/api_mainServer';
...
class Business extends PageBusinessBasic {
  ...
  // (페이지 외곽 프레임 비즈니스)
  gcoOuterFrameBusiness: GcoOuterFrameBusiness = new GcoOuterFrameBusiness(this, "Post 메소드 요청 샘플 5 (multipart/form-data - File List)");
  ...
  requestFormImple: PostService1TkV1RequestTestPostRequestMultipartFormData2AsyncRequestBody | null = null;
  ...
  onClickRequest = async () => {
    ...
    const requestResult = await postService1TkV1RequestTestPostRequestMultipartFormData2Async(
      {},
      {},
  ...
  handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      this.requestFormImple = {
        ...this.requestForm,
        multipartFileList: Array.from(e.target.files),
        multipartFileNullableList: null
      }
    } else {
      this.requestFormImple = null;
    }
