...
const View: React.FC = () => {
  ...
  mainBusiness.captureRef = useRef<HTMLDivElement>(null);
      ...
      <GcoDialogFrame business={mainBusiness.gcoDialogFrameBusiness}>
        <GcoOuterFrame business={mainBusiness.gcoOuterFrameBusiness} >
          <div id={styles.MainContent}>
            ...
            <h2>캡쳐 영역</h2>
            <div ref={mainBusiness.captureRef} style={{ padding: '20px', border: '1px solid black' }}>
              <h1 style={{ marginBottom: '1rem' }}>Sample Content</h1>
              ...
              <img
                src="http://127.0.0.1:8080/service1/tk/v1/file-test/client-image-test?delayTimeSecond=0"
                alt="Sample"
                style={{ display: 'block', marginTop: '1rem', width: '120px', height: '120px' }}
              />
