...
import { postService1TkV1RequestTestPostRequestApplicationJsonWithNoParamAsync } from '../../repositories/network/apis/api_mainServer';
...
class Business extends PageBusinessBasic {
  ...
  // (페이지 외곽 프레임 비즈니스)
  gcoOuterFrameBusiness: GcoOuterFrameBusiness = new GcoOuterFrameBusiness(this, "Post 메소드 요청 샘플 7 (입출력값 없음)");
  ...
  onClickRequest = async () => {
    const requestResult = await postService1TkV1RequestTestPostRequestApplicationJsonWithNoParamAsync(
      {},
      {},
      {}
    );
