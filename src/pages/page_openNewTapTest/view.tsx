      ...
      <GcoDialogFrame business={mainBusiness.gcoDialogFrameBusiness}>
        <GcoOuterFrame business={mainBusiness.gcoOuterFrameBusiness} >
          <span id={styles.MainContent}>
            <div id={styles.PageStateLabel} className={styles.SampleLabel}>열기 : {mainBusiness.newTapUrl}</div>
            <br />

            <button id={styles.PageChangeButton} onClick={mainBusiness.openNewTap}>새 탭 열기</button>
            <br />
            <button id={styles.PageChangeButton} onClick={mainBusiness.openInThisTap}>현재 탭에서 열기</button>
          </span>
          <ToastContainer
            newestOnTop={mainBusiness.toastNewestOnTop}
            rtl={mainBusiness.toastRightToLeftLayout}
