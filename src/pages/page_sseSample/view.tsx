...
const View: React.FC = () => {
  ...
  mainBusiness.sseEventLogRef = useRef<HTMLDivElement>(null);
      ...
      <GcoDialogFrame business={mainBusiness.gcoDialogFrameBusiness}>
        <GcoOuterFrame business={mainBusiness.gcoOuterFrameBusiness} >
          <div id={styles.MainContent}>
            <h3>SSE 동작 버튼</h3>
            <button id={styles.SseEventTriggerButton} onClick={mainBusiness.handleEventTriggerClick}>SSE 이벤트 트리거</button>
            <button id={styles.SseSubscribeButton} onClick={mainBusiness.handleSseToggleClick}>
              {mainBusiness.sse ? 'SSE 구독 해제' : 'SSE 구독'}
            </button>
            ...
            <div
              id="trigger_test"
              ref={mainBusiness.sseEventLogRef}
              style={{
                overflowY: 'scroll',
                width: '300px',
                height: '150px',
