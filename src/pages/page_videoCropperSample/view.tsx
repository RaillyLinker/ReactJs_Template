      ...
      <GcoDialogFrame business={mainBusiness.gcoDialogFrameBusiness}>
        <GcoOuterFrame business={mainBusiness.gcoOuterFrameBusiness} >
          <div id={styles.MainContent}>
            ...
            <br />
            <div>Start time (sec) : {mainBusiness.startTime}</div>
            <button onClick={mainBusiness.setStartTimeFromVideoTime}>
              Set Start Time
            </button>
            <br />
            <div>End time (sec) : {mainBusiness.endTime}</div>
            <button onClick={mainBusiness.setEndTimeFromVideoTime}>
              Set End Time
            </button>
            <br />
