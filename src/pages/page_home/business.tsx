...
class Business extends PageBusinessBasic {
  ...
  items: {
    ...
    [
      ...
      {
        uid: 3,
        itemTitle: "미디어 샘플 리스트",
        itemDescription: "비디오, 이미지, 오디오 등 미디어 데이터 처리 관련 샘플 리스트",
        onItemClicked: (): void => {
      ...
      {
        uid: 5,
        itemTitle: "지리 정보 샘플 리스트",
        itemDescription: "지리 정보 처리 관련 샘플 리스트",
        onItemClicked: (): void => {
          this.navigate("/geo-sample-list");
        }
      },
      // todo
      {
