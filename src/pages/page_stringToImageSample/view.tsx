        ...
        <GcoOuterFrame business={mainBusiness.gcoOuterFrameBusiness} >
          <div id={styles.MainContent}>
            <input
              id={styles.TextInput}
              type="text"
              value={mainBusiness.srcText}
              onChange={mainBusiness.textInputOnChange}
              placeholder="이미지 변환 텍스트 입력"
            />
            <button
              id={styles.StringToImageButton}
              onClick={mainBusiness.handleGenerateSignature}
            >
              이미지 생성
            </button>
          </div>
