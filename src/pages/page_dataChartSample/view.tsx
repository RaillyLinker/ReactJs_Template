      ...
      <GcoDialogFrame business={mainBusiness.gcoDialogFrameBusiness}>
        <GcoOuterFrame business={mainBusiness.gcoOuterFrameBusiness} >
          <div id={styles.MainContent}>
            <div id={styles.ChartContent}>
              <div >
                <h2>Bar Chart</h2>
                <Bar data={mainBusiness.barData} options={{ responsive: true }} />
              </div>

              <div >
                <h2>Line Chart</h2>
                <Line data={mainBusiness.lineData} options={{ responsive: true }} />
              </div>

              <div>
                <h2>Pie Chart</h2>
                <Pie data={mainBusiness.pieData} options={{ responsive: true }} />
              </div>

              <div >
                <h2>Doughnut Chart</h2>
                <Doughnut data={mainBusiness.doughnutData} options={{ responsive: true }} />
              </div>
            </div>
          </div>
          <ToastContainer
